              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-800/80 dark:text-blue-200/80 space-y-1.5 font-medium">
                    <p>• Write a clear and engaging title that captures attention</p>
                    <p>• Use proper formatting and paragraphs for readability</p>
                    <p>• Choose relevant categories to help readers find your content</p>
                    <p>• Add a high-quality featured image to make your post stand out</p>
                  </div>
                </div>
              </div>
            </div>
