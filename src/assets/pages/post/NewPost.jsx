              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-1 text-sm text-blue-700">
                    ...
                    <p>
                      • Use proper formatting and paragraphs for readability
                    </p>
                    <p>
                      • Choose relevant categories to help readers find your
                      content
                    </p>
                    <p>
                      • Add a high-quality featured image to make your post
                      stand out
                    </p>
                  </div>
                </div>
